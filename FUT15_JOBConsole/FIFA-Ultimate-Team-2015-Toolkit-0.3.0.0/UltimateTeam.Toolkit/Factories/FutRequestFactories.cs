...
namespace UltimateTeam.Toolkit.Factories
{
    public class FutRequestFactories
    {
        ...
        private Func<AuctionInfo, long, IFutRequest<AuctionResponse>> _placeBidRequestFactory;
        ...
        {
            get { return _resources.FutHome; }
            set
            {
                value.ThrowIfInvalidArgument();
                _resources.FutHome = value;
            }
        }
        ...
        public Func<AuctionInfo, long, IFutRequest<AuctionResponse>> PlaceBidRequestFactory
        {
            get
            {
